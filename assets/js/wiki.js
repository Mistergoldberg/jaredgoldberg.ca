...
function buildHierarchicalMenu(){
  ...
  const menuTree = [
    ...
    },
    {
      label: '🧠 Writing',
      children: [
        { label: 'What Do the Wealthy, the Sun, and Popular Kids Have in Common?', href: href('writing/what-do-the-wealthy/') },
        { label: 'Baseball Bats and Dominance Hierarchies', href: href('writing/baseball-bats/') },
        { label: 'Why the Medium Is the Message', href: href('writing/medium-is-the-message/') },
        { label: 'We Behave Like Ants: Feedback Loops and Collective Failure', href: href('writing/we-behave-like-ants/') },
        { label: 'What Does It All Mean?', href: href('writing/what-does-it-all-mean/') },
        { label: 'If Luck Is Structural, What Do We Teach Our Kids?', href: href('writing/if-luck-is-structural/') },
        { label: 'Civic Design Failure: Why We Teach Money Too Late', href: href('writing/civic-design-failure/') },
        { label: 'Compounding Bad Luck Is Expensive for You Too', href: href('writing/compounding-bad-luck/') },
        { label: 'What Real Systems Taught Me About Incentives', href: href('writing/real-systems-incentives/') },
        { label: 'This Summer, We\'re Building Infrastructure', href: href('writing/building-infrastructure/') },
        { label: 'The Misaligned Compass', href: href('writing/the-misaligned-compass/') },
        { label: 'Debt, Slavery, and the Treasury', href: href('writing/debt-slavery-treasury/') },
        { label: 'Why Roman Law Still Runs the World', href: href('writing/why-roman-law-still-runs-the-world/') },
        { label: 'AI: This Isn\'t About Us', href: href('writing/ai-is-not-about-us/') },
      ],
    },
    {
      label: '💰 Projects',
