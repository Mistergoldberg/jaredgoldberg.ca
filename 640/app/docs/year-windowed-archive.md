...
These measurements validated the bounded architecture in desktop Chrome and mobile emulation. The exact `76ae730` QA release passed physical iPhone 17 testing in Safari and Chrome on iOS 26.6.1 and was promoted unchanged to production on 2026-09-09. Public post-cutover diagnostics again retained one mounted year, one layout, two cache entries and two observers with zero inactive-year images or bound warnings after 30 orientation changes. Each new UX release still requires its own physical acceptance pass.
